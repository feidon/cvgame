    ...
    return (
        ...
        <Container component="main" sx={{ mt: 8, mb: 2 }} >
            ...
            <Typography variant="h6" component="h2" gutterBottom>
                {'The main idea of this project is about combining computer vision technology with web game. We use the deep learning model to do on-time prediction of your pose, hand sign, etc. \
                Than use it for writing game logic.' }<br/>

...
const Instruction = ({ setIsInstruction }) => {
    ...
    return (
        <div className="background">
            <h1 className="title"> Play Rock-Paper-Scissors with Hand Pose Detection ! </h1>
            <div className="container-instruction">
                ...
                <div className="image-container">
                    <img className="image" src={RPS_icon} alt="Rock-Paper-Scissors"/>
                    <img className="image" src={mora_pose} alt="Mora Pose"/>
                </div>
            </div>
